  ...
  return (
    <>
      ...
      <section className="desktop:relative mobile:pt-[3.75rem] pt-[7.5rem] bg-kc-bg_lightgray">
        ...
        after:block after:w-full desktop:after:h-[394px] laptop:after:h-[315px] after:bg-kc-article_bg
        after:absolute after:bottom-0 laptop:after:bottom-40  mobile:hidden"
        ></div>
