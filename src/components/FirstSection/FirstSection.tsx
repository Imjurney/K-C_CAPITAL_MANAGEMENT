...
export const FirstSection = forwardRef((_, ref: ForwardedRef<HTMLElement>) => {
  return (
    ...
    >
      ...
      <article className="mobile:px-5 mobile:text-sm  desktop:text-xl mobile:pt-7\  desktop:px-[8.875rem] desktop:pt-[3.75rem] ">
      ...
      <picture className="pt-9">
        ...
        />
        <img
          className="desktop:px-[10.5rem] desktop:pt-[4.6875rem]mobile:px-12 mobile:pt-8"
